...
class Test extends Base
{
    ...
    {
        $comment_class = model('Comment')->getCommonClassByDealId($deal_id); // 获得评论等级 good_comment middle_comment bad_comment score
        $comments = model('Comment')->getCommentInfoByDealId($deal_id); // 获得评论信息
